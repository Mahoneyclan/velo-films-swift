...
struct SelectRow: Codable {
    ...
    var asEnrichRow: EnrichRow {
        EnrichRow(index: index, camera: camera, clipNum: clipNum,
                  frameNumber: frameNumber, videoPath: videoPath,
                  absTimeEpoch: absTimeEpoch, absTimeIso: absTimeIso,
                  sessionTsS: sessionTsS, clipStartEpoch: clipStartEpoch,
                  adjustedStartTime: adjustedStartTime, durationS: durationS,
                  ...
                  objectDetected: objectDetected, sceneBoost: sceneBoost,
                  gpxEpoch: gpxEpoch, gpxTimeUtc: gpxTimeUtc,
                  lat: lat, lon: lon, elevation: elevation,
                  hrBpm: hrBpm, cadenceRpm: cadenceRpm,
                  speedKmh: speedKmh, gradientPct: gradientPct,
                  scoreComposite: scoreComposite, scoreWeighted: scoreWeighted,
                  segmentBoost: segmentBoost, momentId: momentId)
    }
